...
//        FileInputStream balloon = new FileInputStream("src/main/resourse/ball.png");
        InputStream balloon = Main.class.getResourceAsStream("../ball.png");
        Image image1 = new Image(balloon);
        InputStream burst = Main.class.getResourceAsStream("../burst.png");
...
//                    Main.LABEL_SCORE.setText("Score: " + String.valueOf(SCORE));
                    ...
                    AudioClip ALERT_AUDIOCLIP = new AudioClip(Main.class.getResource("../trueClick.mp3").toString());
...
//                Main.LANE_LIST.get(0).getLaneFlowPane().getChildren().add(this.getBallon().getStackPane());
    ...
    private void flyUp() throws InterruptedException {
        ...
        translateTransition.setDuration(Duration.millis(12000));
